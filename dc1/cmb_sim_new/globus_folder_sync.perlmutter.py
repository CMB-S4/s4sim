...
# NERSC Perlmutter endpoint (only way to access Perlmutter scratch)
SOURCE_ENDPOINT = '6bdc7956-fc0f-4ad2-989c-7aa5ee643a79'

# NERSC DTN endpoint
# DESTINATION_ENDPOINT = '9d6d994a-6d04-11e5-ba46-22000b92c6ec'
# NERSC Perlmutter endpoint (only way to access Perlmutter scratch)
DESTINATION_ENDPOINT = '6bdc7956-fc0f-4ad2-989c-7aa5ee643a79'

# NERSC cmbs4 collaboration account endpoint (less bandwith)
#DESTINATION_ENDPOINT = 'fb077a06-6f06-11ec-b2c3-1b99bfd4976a'

# Copy data off of the endpoint share
SOURCE_PATH = '/pscratch/sd/k/keskital/s4sim/dc1/foreground_sim/outputs/LAT0_CHLAT'

# Destination Path -- The directory will be created if it doesn't exist
DESTINATION_PATH = '/global/cfs/cdirs/cmbs4/dc/dc1/staging/foreground_sim/outputs_rk/LAT0_CHLAT'

TRANSFER_LABEL = 'DC1 foreground Sync'
...
CLIENT_ID = 'b2dd6112-72f8-41b3-a904-4810f79db178'
DATA_FILE = 'transfer-data.json'
REDIRECT_URI = 'https://auth.globus.org/v2/web/auth-code'
SCOPES = ('openid email profile '
          'urn:globus:auth:scope:transfer.api.globus.org:all')

APP_NAME = 'globus_folder_sync.perlmutter.py'
