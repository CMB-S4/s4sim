...
for band, freq in [
    ...
    if os.path.isfile(fname_out):
        ...
        continue
    fname_in = f"/global/cfs/cdirs/cmbs4/dc/dc0/sky/4096/combined_cmb_unlensed_dipole/0000/cmbs4_combined_cmb_unlensed_dipole_uKCMB_LAT-{band}_nside4096_0000.fits"
