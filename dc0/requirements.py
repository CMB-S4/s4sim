...
Chile_LAT = {
    ...
    25: [7.8, 27.1, 415, 3.5, 37.6, 700, 1.4],
    40: [5.3, 11.6, 391, 3.5, 15.5, 700, 1.4], 
    90: [2.2, 2.0, 1932, 3.5, 2.7, 700, 1.4],
    150: [1.4, 2.0, 3917, 3.5, 3.0, 700, 1.4],
    230: [1.0, 6.9, 6740, 3.5, 9.8, 700, 1.4],
    280: [0.9, 16.7, 6792, 3.5, 23.9, 700, 1.4],
    # freq: [beam_arcmins, white_noise_T, elknee_T, alphaknee_T, whitenoise_P, elknee_P, alphaknee_P]
...
Pole_LAT = {
    ...
    25: [9.1, 6.5, 1200, 4.2, 5.5, 150, 2.7],
    40: [6.2, 3.0, 1200, 4.2, 4.3, 150, 2.7], 
    90: [2.5, 0.45, 1200, 4.2, 0.69, 150, 2.6],
    150: [1.6, 0.41, 1900, 4.1, 0.75, 200, 2.2],
    230: [1.1, 1.3, 2100, 4.1, 2.2, 200, 2.2],
    280: [1.0, 3.1, 2100, 3.9, 5.3, 200, 2.2],
    # freq: [beam_arcmins, white_noise_T, elknee_T, alphaknee_T, whitenoise_P, elknee_P, alphaknee_P]
...
Pole_SAT = {
    ...
    25: [85.2, 5.6, 150, 4.4, 3.9, 60, 2.2, 3.9, 60, 1.7],
    ...
    230: [13.0, 7.9, 230, 3.8, 2.3, 65, 3.1, 2.3, 60, 3.0],
    280: [13.0, 13., 230, 3.8, 5.5, 65, 3.1, 5.5, 60, 3.0],
    # freq: [beam_arcmins, white_noise_T, elknee_T, alphaknee_T, whitenoise_E, elknee_E, alphaknee_E, whitenoise_B, elknee_B, alphaknee_B]
