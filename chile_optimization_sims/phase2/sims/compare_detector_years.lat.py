...
for freq in 20, 30, 40, 90, 150, 220, 280:
    ...
    fname0 = f"../../phase1/sims/outputs/lat_delensing/{band}/mapmaker_hits.fits"
    fname1 = f"outputs/lat_delensing_max/{band}/season/mapmaker_hits.fits"
    fname2 = f"outputs/lat_delensing_max/{band}/break/mapmaker_hits.fits"
