...
f_total["lat_wide"] = {
    "season" : {
        "f020" : 0.25 / f_sensitivity,
        "f030" : 0.25 / f_sensitivity,
        "f040" : 0.25 / f_sensitivity,
        "f090" : 0.25 / f_sensitivity,
        "f150" : 0.25 / f_sensitivity,
        "f220" : 0.22 / f_sensitivity,
        "f280" : 0.15 / f_sensitivity,
    },
    "break" : {
        "f020" : 0.02 / f_sensitivity,
        "f030" : 0.02 / f_sensitivity,
        "f040" : 0.02 / f_sensitivity,
        "f090" : 0.02 / f_sensitivity,
        "f150" : 0.02 / f_sensitivity,
        "f220" : 0.02 / f_sensitivity,
...
f_total["lat_delensing"] = {
    "season" : {
        "f020" : 0.24 / f_sensitivity,
        "f030" : 0.24 / f_sensitivity,
        "f040" : 0.24 / f_sensitivity,
        "f090" : 0.24 / f_sensitivity,
        "f150" : 0.24 / f_sensitivity,
        "f220" : 0.21 / f_sensitivity,
        "f280" : 0.15 / f_sensitivity,
    },
    "break" : {
        "f020" : 0.02 / f_sensitivity,
...
for flavor in "lat_wide", "lat_delensing":
