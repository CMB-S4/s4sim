...
pwv_limits = [2, 3]
fname_in = "schedule_splat.txt"

first_time = dateutil.parser.parse(f"2030-01-01 00:00:00 00:00:00 +0000")
break_start = dateutil.parser.parse(f"2030-11-01 00:00:00 00:00:00 +0000")
break_stop = dateutil.parser.parse(f"2030-02-01 00:00:00 00:00:00 +0000")
break_frac = 1  # adjust pwv_limit during the break to meet this efficiency
...
for pwv_limit in pwv_limits:
    ...
    with open(fname_in, "r") as schedule_in:
        ...
        for line in schedule_in:
            ...
            during_break = start_time < break_stop or start_time > break_start
            if during_break:
